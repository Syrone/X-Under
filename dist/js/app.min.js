...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var malePath = currentPath.endsWith('main-male.html');
  var femalePath = currentPath.endsWith('main-female.html');
  if (versionBtns) {
  ...
  if (wrapper) {
    ...
    var observerNavbar = new MutationObserver(updateWrapperMarginTop);
...
/******/(function () {
  ...
  function findElementsInElements() {
    ...
    elements.forEach(function (el) {
      found.push.apply(found, _toConsumableArray2(el.querySelectorAll(selector)));
    });
    return found;
  }
  function elementChildren(element) {
    var selector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    return _toConsumableArray2(element.children).filter(function (el) {
  ...
  function createElement(tag) {
    ...
    (_el$classList = el.classList).add.apply(_el$classList, _toConsumableArray2(Array.isArray(classes) ? classes : [classes]));
    return el;
  }
  function elementOffset(el) {
    var window = getWindow();
    ...
    if (isSafari()) {
      ...
      if (ua.includes('Version/')) {
        var _ua$split$1$split$0$s = ua.split('Version/')[1].split(' ')[0].split('.').map(function (num) {
          ...
          _ua$split$1$split$0$s2 = _slicedToArray2(_ua$split$1$split$0$s, 2),
      ...
      observer = new ResizeObserver(function (entries) {
        animationFrame = window.requestAnimationFrame(function () {
          ...
          entries.forEach(function (_ref5) {
            var contentBoxSize = _ref5.contentBoxSize,
              contentRect = _ref5.contentRect,
              target = _ref5.target;
            if (target && target !== swiper.el) return;
            newWidth = contentRect ? contentRect.width : (contentBoxSize[0] || contentBoxSize).inlineSize;
            newHeight = contentRect ? contentRect.height : (contentBoxSize[0] || contentBoxSize).blockSize;
      ...
      eventsArray.forEach(function (event) {
        if (self.eventsAnyListeners && self.eventsAnyListeners.length) {
          self.eventsAnyListeners.forEach(function (eventHandler) {
            eventHandler.apply(context, [event].concat(_toConsumableArray2(data)));
          });
        }
        if (self.eventsListeners && self.eventsListeners[event]) {
  ...
  function updateSlides() {
    ...
    if (!params.centeredSlides) {
      var newSlidesGrid = [];
      for (var _i4 = 0; _i4 < snapGrid.length; _i4 += 1) {
        var slidesGridItem = snapGrid[_i4];
        if (params.roundLengths) slidesGridItem = Math.floor(slidesGridItem);
        if (snapGrid[_i4] <= swiper.virtualSize - swiperSize) {
          newSlidesGrid.push(slidesGridItem);
        }
      }
      snapGrid = newSlidesGrid;
    ...
    if (isVirtual && params.loop) {
      ...
      if (params.slidesPerGroup > 1) {
        ...
        for (var _i5 = 0; _i5 < groups; _i5 += 1) {
          snapGrid.push(snapGrid[snapGrid.length - 1] + groupSize);
        }
      }
      for (var _i6 = 0; _i6 < swiper.virtual.slidesBefore + swiper.virtual.slidesAfter; _i6 += 1) {
        if (params.slidesPerGroup === 1) {
          snapGrid.push(snapGrid[snapGrid.length - 1] + size);
        }
        slidesGrid.push(slidesGrid[slidesGrid.length - 1] + size);
  ...
  var preload = function preload(swiper) {
    ...
    if (swiper.params.rewind) {
      ...
      for (var _i7 = Math.max(slideIndexLastInView - amount, 0); _i7 <= Math.min(slideIndexLastInView + amount, len - 1); _i7 += 1) {
        if (_i7 !== activeIndex && _i7 > slideIndexLastInView) unlazy(swiper, _i7);
      }
    }
  };
  ; // CONCATENATED MODULE: ./node_modules/swiper/core/update/updateActiveIndex.js
  ...
  ; // CONCATENATED MODULE: ./node_modules/swiper/core/transition/transitionEmit.js
  function transitionEmit(_ref7) {
    var swiper = _ref7.swiper,
      runCallbacks = _ref7.runCallbacks,
  ...
  function loopFix() {
    var _ref8 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      slideRealIndex = _ref8.slideRealIndex,
      _ref8$slideTo = _ref8.slideTo,
      slideTo = _ref8$slideTo === void 0 ? true : _ref8$slideTo,
      direction = _ref8.direction,
      setTranslate = _ref8.setTranslate,
      activeSlideIndex = _ref8.activeSlideIndex,
      byController = _ref8.byController,
      byMousewheel = _ref8.byMousewheel;
    var swiper = this;
    if (!swiper.params.loop) return;
    swiper.emit('beforeLoopFix');
    var slides = swiper.slides,
    ...
    if (activeSlideIndex < loopedSlides) {
      ...
      slidesAppended = Math.max(activeSlideIndex - (swiper.slides.length - loopedSlides * 2), params.slidesPerGroup);
      for (var _i8 = 0; _i8 < slidesAppended; _i8 += 1) {
        var _index = _i8 - Math.floor(_i8 / slides.length) * slides.length;
  ...
  function addClasses() {
    ...
    classNames.push.apply(classNames, _toConsumableArray2(suffixes));
    (_el$classList2 = el.classList).add.apply(_el$classList2, _toConsumableArray2(classNames));
    swiper.emitContainerClasses();
  }
  ; // CONCATENATED MODULE: ./node_modules/swiper/core/classes/removeClasses.js
  function removeClasses() {
    ...
    (_el$classList3 = el.classList).remove.apply(_el$classList3, _toConsumableArray2(classNames));
    swiper.emitContainerClasses();
  }
  ; // CONCATENATED MODULE: ./node_modules/swiper/core/classes/index.js
  ...
  var Swiper = /*#__PURE__*/function () {
    function Swiper() {
      ...
      swiper.eventsListeners = {};
      swiper.eventsAnyListeners = [];
      swiper.modules = _toConsumableArray2(swiper.__modules__);
      if (params.modules && Array.isArray(params.modules)) {
        var _swiper$modules;
        (_swiper$modules = swiper.modules).push.apply(_swiper$modules, _toConsumableArray2(params.modules));
      }
    ...
    _createClass(Swiper, [{
      ...
      value: function slidesPerViewDynamic() {
        ...
        if (params.centeredSlides) {
          ...
          for (var _i9 = activeIndex - 1; _i9 >= 0; _i9 -= 1) {
            if (slides[_i9] && !breakLoop) {
              slideSize += slides[_i9].swiperSlideSize;
              spv += 1;
              if (slideSize > swiperSize) breakLoop = true;
            }
          }
          ...
          // eslint-disable-next-line
          if (view === 'current') {
            for (var _i10 = activeIndex + 1; _i10 < slides.length; _i10 += 1) {
              var slideInView = exact ? slidesGrid[_i10] + slidesSizesGrid[_i10] - slidesGrid[activeIndex] < swiperSize : slidesGrid[_i10] - slidesGrid[activeIndex] < swiperSize;
              if (slideInView) {
                spv += 1;
              }
            }
            ...
            // previous
            for (var _i11 = activeIndex - 1; _i11 >= 0; _i11 -= 1) {
              var _slideInView = slidesGrid[activeIndex] - slidesGrid[_i11] < swiperSize;
              if (_slideInView) {
                spv += 1;
              }
            }
      ...
      value: function update() {
        ...
        _toConsumableArray2(swiper.el.querySelectorAll('[loading="lazy"]')).forEach(function (imageEl) {
          if (imageEl.complete) {
            processLazyPreloader(swiper, imageEl);
          }
        });
  ...
  function Virtual(_ref9) {
    ...
    function update(force) {
      ...
      for (var _i12 = loopFrom; _i12 < loopTo; _i12 += 1) {
        if (_i12 >= from && _i12 <= to) {
          var _slideIndex = getSlideIndex(_i12);
          if (typeof previousTo === 'undefined' || force) {
            appendIndexes.push(_slideIndex);
          } else {
            if (_i12 > previousTo) appendIndexes.push(_slideIndex);
            if (_i12 < previousFrom) prependIndexes.push(_slideIndex);
          }
        }
      }
      ...
      if (isLoop) {
        for (var _i13 = prependIndexes.length - 1; _i13 >= 0; _i13 -= 1) {
          var index = prependIndexes[_i13];
          swiper.slidesEl.prepend(renderSlide(slides[index], index));
        }
      } else {
    ...
    on('beforeInit', function () {
      ...
      if (typeof swiper.passedParams.virtual.slides === 'undefined') {
        var slides = _toConsumableArray2(swiper.slidesEl.children).filter(function (el) {
          return el.matches(".".concat(swiper.params.slideClass, ", swiper-slide"));
        });
        if (slides && slides.length) {
          swiper.virtual.slides = _toConsumableArray2(slides);
          domSlidesAssigned = true;
  ...
  function Navigation(_ref12) {
    ...
    function getEl(el) {
      ...
      if (el) {
        if (typeof el === 'string') res = _toConsumableArray2(document.querySelectorAll(el));
        if (swiper.params.uniqueNavElements && typeof el === 'string' && res.length > 1 && swiper.el.querySelectorAll(el).length === 1) {
          res = swiper.el.querySelector(el);
        }
      }
    ...
    function toggleEl(el, disabled) {
      ...
      el.forEach(function (subEl) {
        if (subEl) {
          ...
          (_subEl$classList = subEl.classList)[disabled ? 'add' : 'remove'].apply(_subEl$classList, _toConsumableArray2(params.disabledClass.split(' ')));
          if (subEl.tagName === 'BUTTON') subEl.disabled = disabled;
          if (swiper.params.watchOverflow && swiper.enabled) {
            subEl.classList[swiper.isLocked ? 'add' : 'remove'](params.lockClass);
          }
    ...
    function init() {
      ...
      var initButton = function initButton(el, dir) {
        ...
        if (!swiper.enabled && el) {
          var _el$classList4;
          (_el$classList4 = el.classList).add.apply(_el$classList4, _toConsumableArray2(params.lockClass.split(' ')));
        }
      };
    ...
    function destroy() {
      ...
      var destroyButton = function destroyButton(el, dir) {
        var _el$classList5;
        el.removeEventListener('click', dir === 'next' ? onNextClick : onPrevClick);
        (_el$classList5 = el.classList).remove.apply(_el$classList5, _toConsumableArray2(swiper.params.navigation.disabledClass.split(' ')));
      };
      nextEl.forEach(function (el) {
    ...
    on('enable disable', function () {
      ...
      nextEl = makeElementsArray(nextEl);
      prevEl = makeElementsArray(prevEl);
      [].concat(_toConsumableArray2(nextEl), _toConsumableArray2(prevEl)).filter(function (el) {
        return !!el;
      }).forEach(function (el) {
    ...
    var enable = function enable() {
      ...
      (_swiper$el$classList = swiper.el.classList).remove.apply(_swiper$el$classList, _toConsumableArray2(swiper.params.navigation.navigationDisabledClass.split(' ')));
      init();
      update();
    };
    var disable = function disable() {
      var _swiper$el$classList2;
      (_swiper$el$classList2 = swiper.el.classList).add.apply(_swiper$el$classList2, _toConsumableArray2(swiper.params.navigation.navigationDisabledClass.split(' ')));
      destroy();
    };
    Object.assign(swiper.navigation, {
      enable: enable,
  ...
  function Pagination(_ref13) {
    ...
    function update() {
      ...
      if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
        ...
        bullets.forEach(function (bulletEl) {
          ...
          var classesToRemove = _toConsumableArray2(['', '-next', '-next-next', '-prev', '-prev-prev', '-main'].map(function (suffix) {
            return "".concat(params.bulletActiveClass).concat(suffix);
          })).map(function (s) {
            return typeof s === 'string' && s.includes(' ') ? s.split(' ') : s;
          }).flat();
          (_bulletEl$classList = bulletEl.classList).remove.apply(_bulletEl$classList, _toConsumableArray2(classesToRemove));
        });
        if (el.length > 1) {
          bullets.forEach(function (bullet) {
            ...
            if (bulletIndex === current) {
              ...
              (_bullet$classList = bullet.classList).add.apply(_bullet$classList, _toConsumableArray2(params.bulletActiveClass.split(' ')));
            }
            if (params.dynamicBullets) {
              if (bulletIndex >= firstIndex && bulletIndex <= lastIndex) {
                var _bullet$classList2;
                (_bullet$classList2 = bullet.classList).add.apply(_bullet$classList2, _toConsumableArray2("".concat(params.bulletActiveClass, "-main").split(' ')));
              }
              if (bulletIndex === firstIndex) {
                setSideBullets(bullet, 'prev');
              }
          ...
          if (bullet) {
            ...
            (_bullet$classList3 = bullet.classList).add.apply(_bullet$classList3, _toConsumableArray2(params.bulletActiveClass.split(' ')));
          }
          if (params.dynamicBullets) {
            ...
            for (var i = firstIndex; i <= lastIndex; i += 1) {
              if (bullets[i]) {
                ...
                (_bullets$i$classList = bullets[i].classList).add.apply(_bullets$i$classList, _toConsumableArray2("".concat(params.bulletActiveClass, "-main").split(' ')));
              }
            }
            setSideBullets(firstDisplayedBullet, 'prev');
            setSideBullets(lastDisplayedBullet, 'next');
    ...
    function render() {
      ...
      el.forEach(function (subEl) {
        ...
        if (params.type === 'bullets') {
          ...
          (_swiper$pagination$bu = swiper.pagination.bullets).push.apply(_swiper$pagination$bu, _toConsumableArray2(subEl.querySelectorAll(classesToSelector(params.bulletClass))));
        }
      });
      if (params.type !== 'custom') {
        emit('paginationRender', el[0]);
    ...
    function init() {
      ...
      if (!el && typeof params.el === 'string') {
        el = _toConsumableArray2(document.querySelectorAll(params.el));
      }
      if (!el) {
        el = params.el;
      }
      if (!el || el.length === 0) return;
      if (swiper.params.uniqueNavElements && typeof params.el === 'string' && Array.isArray(el) && el.length > 1) {
        el = _toConsumableArray2(swiper.el.querySelectorAll(params.el));
        // check if it belongs to another nested Swiper
        if (el.length > 1) {
    ...
    function destroy() {
      ...
      if (swiper.pagination.bullets) swiper.pagination.bullets.forEach(function (subEl) {
        ...
        return (_subEl$classList2 = subEl.classList).remove.apply(_subEl$classList2, _toConsumableArray2(params.bulletActiveClass.split(' ')));
      });
    }
  ...
  function Zoom(_ref16) {
    ...
    function eventWithinZoomContainer(e) {
      ...
      if (e.target.matches(selector)) return true;
      if (_toConsumableArray2(swiper.el.querySelectorAll(selector)).filter(function (containerEl) {
    ...
    function onGestureStart(e) {
      ...
      if (gesture.imageEl) {
        var _getScaleOrigin = getScaleOrigin(),
          _getScaleOrigin2 = _slicedToArray2(_getScaleOrigin, 2),
  ...
  function A11y(_ref18) {
    ...
    var init = function init() {
      ...
      // Navigation
      var _ref19 = swiper.navigation ? swiper.navigation : {},
        nextEl = _ref19.nextEl,
        prevEl = _ref19.prevEl;
      nextEl = makeElementsArray(nextEl);
      prevEl = makeElementsArray(prevEl);
      if (nextEl) {
        nextEl.forEach(function (el) {
    ...
    function destroy() {
      if (liveRegion) liveRegion.remove();
      var _ref20 = swiper.navigation ? swiper.navigation : {},
        nextEl = _ref20.nextEl,
        prevEl = _ref20.prevEl;
      nextEl = makeElementsArray(nextEl);
      prevEl = makeElementsArray(prevEl);
      if (nextEl) {
        nextEl.forEach(function (el) {
  ...
  function HashNavigation(_ref22) {
    ...
    function update(initial) {
      ...
      if (thumbsSwiper.params.loop || thumbsSwiper.params.virtual && thumbsSwiper.params.virtual.enabled) {
        ...
        for (var _i14 = 0; _i14 < thumbsToActivate; _i14 += 1) {
          if (thumbsSwiper.slides[swiper.realIndex + _i14]) {
            thumbsSwiper.slides[swiper.realIndex + _i14].classList.add(thumbActiveClass);
          }
        }
      }
  ...
  function freeMode(_ref25) {
    ...
    function onTouchEnd(_ref26) {
      var currentPos = _ref26.currentPos;
      var params = swiper.params,
        wrapperEl = swiper.wrapperEl,
        rtl = swiper.rtlTranslate,
        snapGrid = swiper.snapGrid,
  ...
  function addSlide(index, slides) {
    ...
    if (_typeof2(slides) === 'object' && 'length' in slides) {
      for (var _i15 = 0; _i15 < slides.length; _i15 += 1) {
        if (slides[_i15]) slidesEl.append(slides[_i15]);
      }
      newActiveIndex = activeIndexBuffer > index ? activeIndexBuffer + slides.length : activeIndexBuffer;
    } else {
      slidesEl.append(slides);
    }
    for (var _i16 = 0; _i16 < slidesBuffer.length; _i16 += 1) {
      slidesEl.append(slidesBuffer[_i16]);
    }
    swiper.recalcSlides();
    if (params.loop) {
      swiper.loopCreate();
  ...
  function removeSlide(slidesIndexes) {
    ...
    var indexToRemove;
    if (_typeof2(slidesIndexes) === 'object' && 'length' in slidesIndexes) {
  ...
  function effectVirtualTransitionEnd(_ref29) {
    var swiper = _ref29.swiper,
      duration = _ref29.duration,
      transformElements = _ref29.transformElements,
      allSlides = _ref29.allSlides;
    var activeIndex = swiper.activeIndex;
  ...
  function EffectCoverflow(_ref33) {
    var swiper = _ref33.swiper,
      extendParams = _ref33.extendParams,
      on = _ref33.on;
    extendParams({
      coverflowEffect: {
        rotate: 50,
  ...
  function EffectCreative(_ref34) {
    var swiper = _ref34.swiper,
      extendParams = _ref34.extendParams,
      on = _ref34.on;
    extendParams({
      creativeEffect: {
        limitProgress: 1,
  ...
  function EffectCards(_ref35) {
    var swiper = _ref35.swiper,
      extendParams = _ref35.extendParams,
      on = _ref35.on;
    extendParams({
      cardsEffect: {
        slideShadows: true,
