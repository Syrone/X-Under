...
dropdownInputs === null || dropdownInputs === void 0 || dropdownInputs.forEach(function (inputDate) {
  inputDate.addEventListener('input', function (event) {
    var input = event.target;
    var inputValue = input.value.replace(/\D/g, '');
    var formattedValue = formatInputDate(inputValue);
